...
The ESPN endpoints are public but unofficial and may change without notice. The
raw cache makes each model run reproducible even if an upstream response later
changes.
